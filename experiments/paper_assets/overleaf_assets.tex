...
% Paths below reference the consolidated experiments/paper_assets package.

\subsection{System Architecture}
The implemented pipeline combines text emotion inference (\texttt{app/text\_emotion.py}) and face emotion inference (\texttt{app/face\_emotion.py}) into a weighted fusion layer (\texttt{app/fusion.py}). The fused emotion drives empathetic response generation in \texttt{app/response\_generator.py}. The architecture is deterministic and reproducible for classroom evaluation and reporting.

\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{experiments/paper_assets/diagrams/system_architecture.png}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{experiments/paper_assets/diagrams/runtime_workflow.png}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.95\linewidth]{experiments/paper_assets/diagrams/fusion_equation.png}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{experiments/paper_assets/diagrams/human_eval_workflow.png}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{experiments/paper_assets/figures/ablation_comparison_plot.png}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{experiments/paper_assets/figures/alpha_sensitivity_plot.png}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{experiments/paper_assets/figures/human_eval_summary_plot.png}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{experiments/paper_assets/figures/helpfulness_plot.png}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{experiments/paper_assets/figures/case_type_distribution_plot.png}
    \caption{Distribution of congruent, dissonant, and ambiguous cases used in evaluation.}
    \label{fig:case_type_distribution_plot}
\end{figure}

% Table inclusion
\input{experiments/paper_assets/tables/paper_tables.tex}
