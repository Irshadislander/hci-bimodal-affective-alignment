...
- Fusion, response generation, and evaluation workflows are in place
- Case studies, mode comparison tables, and human rating sheets can be generated
- Report-ready tables, plots, and draft documents are available

## Remaining Work Before Submission
- Collect completed human ratings if the study is being run
- Aggregate the completed ratings and insert final averages into the report
- Run the report-builder helpers to generate `docs/report_tables.md` and `docs/report_status.md`
- Review the final presentation slides and speaker notes
- Prepare the demo backup screenshots and final submission package
